...
part 'individual_result_event.dart';
part 'individual_result_state.dart';

class IndividualResultBloc
    extends Bloc<IndividualResultEvent, IndividualResultState> {
  IndividualResultBloc()
  ...
  void _triggerInitialMyResults(
      TriggerInitialMyResultsEvent event, Emitter<IndividualResultState> emit) {
  ...
  void _triggerLoadedMyResults(TriggerLoadedMyResultsEvent event,
      Emitter<IndividualResultState> emit) async {
    // print(event.answer);
  ...
  void _triggerLoadingMyResults(
      TriggerLoadingMyResultsEvent event, Emitter<IndividualResultState> emit) {
  ...
  void _triggerDoneLoadingMyResults(TriggerDoneLoadingMyResultsEvent event,
      Emitter<IndividualResultState> emit) {
